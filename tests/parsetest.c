...
int main() {
    ...
    // parameter info
    {
        ...
        if (str_not_equal(res.name, "valves")
            ...
            return error("hr_parse_parameter_info_text 1 failed");
        ...
        if (str_not_equal(res.name, "turbo_available")
            ...
            return error("hr_parse_parameter_info_text 2 failed");
        ...
        if (str_not_equal(res.name, "out_km")
            ...
            return error("hr_parse_parameter_info_text 3 failed");
        ...
        if (str_not_equal(res.name, "use_lights")
            ...
            return error("hr_parse_parameter_info_text 4 failed");
    }
    ...
    // info
    {
        ...
        if (str_not_equal(res.parameter_infos[0].name, "val")
            ...
            return error("hr_parse_info_text 3.3 failed");
        if (str_not_equal(res.parameter_infos[1].name, "center")
            ...
            return error("hr_parse_info_text 3.4 failed");
        if (str_not_equal(res.parameter_infos[2].name, "a")
            ...
            return error("hr_parse_info_text 3.5 failed");
...
//    }

    {
        ...
        if (filetext) {
            res = hr_parse_file(ToStrViu(filetext));
//            printf("%s\n", res.array[0].name);
//            puts("test");
        }
    }
